...
<html>
    <head>
        <meta charset="utf-8" />
        <title>FERMI 10 - Investimenti</title>
        ...
        <div class="menu_laterale">
            ...
            <div class="area_personale">
                ...
                <ul>
                    ...
                    <li class="lista" onmouseover="cambia_sfondo(1, 'Chat');" onmouseleave="cambia_sfondo(2, 'Chat');" id="Chat" ><a href="chat.php">Invia Ricevi Chat</a></li>
                    <li class="lista" id="Carte" onmouseover="cambia_sfondo(1, 'Carte');" onmouseleave="cambia_sfondo(2, 'Carte');"><a href="carte.php">Carte</a></li>
                    <li class="lista" id="Investimenti" onmouseover="cambia_sfondo(1, 'Carte');" onmouseleave="cambia_sfondo(2, 'Carte');" style="background-color: #269e84;"><a style="color: white;" href="investimenti.php">Investimenti</a></li>
